...
<?php
	...
	if(isset($_POST['update'])){
		...
		$mahasiswa = mysqli_query($connect,"UPDATE mahasiswa SET nrp = '$nrp',nama ='$nama',alamat = '$alamat',prodi='$prodi' WHERE nrp='$nrp'");
...
<?php
	...
	$edit_mhs = mysqli_query($connect,"SELECT * FROM mahasiswa WHERE nrp='$nrp'");

	while($data_mhs = mysqli_fetch_array($edit_mhs)){
		$nrp = $data_mhs['nrp'];
		$nama = $data_mhs['nama'];
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#add-dosen">Edit Mahasiswa</a>
          </li>
        </ul>
      </div>
    </div>
          ...
          <form action="edit_mhs.php" method="post" >
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                <label>NRP</label>
                <input class="form-control" id="Nrp"   name="nrp"  type="text" value='<?php echo $nrp; ?>'required="required" data-validation-required-message="Please enter your NRP." disabled>
