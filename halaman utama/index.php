...
<?php
 ...
 <?php
          ...
          $mhs = mysqli_query($connect,"SELECT * FROM mahasiswa, prodi WHERE mahasiswa.id_prodi = prodi.id_prodi ORDER BY nrp ASC");
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <img class="masthead-avatar mb-5" src="cat.png" alt="">
      ...
      <!-- Masthead Subheading -->
      <p class="masthead-subheading font-weight-light mb-0">Penerbitan, validasi,pengumuman, penyimpanan, kerahasiaan, dan semua hal
	  yang berkaitan dengan pengelolaan arsip semua dokumen akademik.</p>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal1">
            ...
            <center><img class="img-fluid" src="img/portfolio/cabin.png" alt=""></center>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal2">
            ...
            <center><img class="img-fluid" src="img/portfolio/cake.png" alt=""></center>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal3">
            ...
            <center><img class="img-fluid" src="img/portfolio/circus.png" alt=""></center>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal4">
            ...
            <center><img class="img-fluid" src="img/portfolio/game.png" alt=""></center>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal5">
            ...
            <center><img class="img-fluid" src="img/portfolio/safe.png" alt=""></center>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal6">
            ...
            <center><img class="img-fluid" src="img/portfolio/submarine.png" alt=""></center>
          </div>
        </div>
        ...
        <div class="col-lg-8 mx-auto">
          ...
          <form action="index.php" method="post" novalidate="novalidate">
            ...
            <div class="form-group">
              <button type="submit" name="submit" class="btn btn-primary btn-xl" id="sendMessageButton">Send</button>
            </div>
          </form>
          <?php
          ...
          if(isset($_POST['submit'])){
            ...
            $data = mysqli_query($connect,"INSERT INTO contact_me values ('','$name','$email','$phone','$message')");
                    ...
                    <tbody>
                      <?php
                        ...
                        while($data_dosen = mysqli_fetch_array($result)) {
                          ...
                          echo "<td> <a class='btn btn-success' href='edit_dosen.php?nip=$data_dosen[nip]'>Edit</a> <a class='btn btn-danger' onclick = 'deleteConfrim(event)' href='delete_dosen.php?nip=$data_dosen[nip]'><i class='fasfa-trash fa-fw'></i>delete</a></td></tr>";
                        }
                      ?>
                    ...
                    <tbody>
                      <?php
                        ...
                        while($data_mhs = mysqli_fetch_array($mhs)) {
                          ...
                          echo "<td> <a class='btn btn-success' href='edit_mhs.php?nrp=$data_mhs[nrp]'>Edit</a> <a class='btn btn-danger' onclick = 'deleteConfrim(event)' href='delete_mhs.php?nrp=$data_mhs[nrp]'><i class='fasfa-trash fa-fw'></i>delete</a></td></tr>";
                        }
                      ?>
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <div>
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <?php
                        $no = 1;
                        while($data_mtk = mysqli_fetch_array($mtk)) {
                          echo"<tr>";
                          echo "<td>".$no++,"</td>";
                          echo "<td>".$data_mtk['kode_matkul']."</td>";
                          echo "<td>".$data_mtk['matkul']."</td>";
                          echo "<td>".$data_mtk['sks']."</td>";
                          echo "<td> <a class='btn btn-success' href='edit_mtk.php?kode_matkul=$data_mtk[kode_matkul]'>Edit</a> <a class='btn btn-danger' onclick = 'deleteConfrim(event)' href='delete_mtk.php?kode_matkul=$data_mtk[kode_matkul]'><i class='fasfa-trash fa-fw'></i>delete</a></td></tr>";
                        }
                      ?>
                ...
                <a class="btn btn-primary" href="add_mtk.php">
                  <i class="fas fa-plus fa-fw"></i>
                  Tambah Matakuliah
                </a>
                <!-- Portfolio Modal - Text -->
        ...
        <div class="modal-body text-center">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                <!-- Portfolio Modal - Title -->
                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">Arsip Dosen</h2>
                <!-- Icon Divider -->
                <div class="divider-custom">
                  <div class="divider-custom-line"></div>
                  <div class="divider-custom-icon">
